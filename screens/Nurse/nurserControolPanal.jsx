...
const NursePages = () => (
  <View style={styles.container}>
    ...
    >
      <Tab.Screen name="SelectPatient" component={SelectPatient} options={{ title: "جلسات اليوم" }} />
      <Tab.Screen name="Search"        component={SearchPatient}  options={{ title: "بحث" }} />
      <Tab.Screen name="Settings"      component={ProfileSettingsScreen} options={{ title: "الإعدادات" }} />
    </Tab.Navigator>
  </View>
);
